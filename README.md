...
UFC・格闘技ファンが、試合や選手について投稿・議論できるコミュニティアプリです。UFC関連ニュース記事の公開・コメント機能も提供します。
...
総合格闘技団体UFCについて、試合や選手について投稿・議論できるコミュニティWebアプリです。掲示板、選手一覧・詳細、選手別コメントに加え、SEO向けのニュース記事（スラッグURL・OGP・SNSシェア）、Google認証、Stripe課金、管理者機能、本番デプロイ構成まで実装しました。
